...
//DIO
  ...
  public static final class OuterArmConstants {
    ...
    public static final int LJSBottomButton = 2; // button channel?
    public static final int LJSTopButton = 3; // button channel?
     ...
     * driveEncoder.setVelocityConversionFactor(Constants.Swerve.
     * driveConversionVelocityFactor);
     * driveEncoder.setPositionConversionFactor(Constants.Swerve.
